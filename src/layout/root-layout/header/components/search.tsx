...
function Suggestions({
  ...
  return (
    <div className="w-full bg-gray-900 backdrop-filter backdrop-blur-xs bg-opacity-60 rounded-2xl absolute mt-1 flex flex-col divide-y-2 divide-slate-400/4.5 transition-all duration-75 ease-in-out z-40 ">
